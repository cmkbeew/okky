...
<body>
	<div id="content">
		...
		<hr>
		<p>
			<(주)오키코리아>('http://www.okky.kr'이하 'OKKY')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.<br><br>
			
			<(주)오키코리아>('OKKY') 은(는) 회사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.<br><br>
			
			○ 본 방침은 2015년 1월 1일부터 시행됩니다.<br><br>
			
			<h3>1. 개인정보의 처리 목적</h3>
			<(주)오키코리아>('https://www.okky.kr'이하 'OKKY')은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.<br><br>
			...
			① <(주)오키코리아>('OKKY')은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의 받은 개인정보 보유,이용기간 내에서 개인정보를 처리,보유합니다.<br><br>
			...
			① <(주)오키코리아>('http://www.okky.kr'이하 'OKKY')은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.<br><br>
			
			② <(주)오키코리아>('http://www.okky.kr')은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.<br><br>
			...
			삭제요구<br>
			처리정지 요구<br><br>
			② 제1항에 따른 권리 행사는(주)오키코리아(‘http://www.okky.kr’이하 ‘OKKY) 에 대해 개인정보 보호법 시행규칙 별지 제8호 서식에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 <기관/회사명>(‘사이트URL’이하 ‘사이트명) 은(는) 이에 대해 지체 없이 조치하겠습니다.
			<br>
			...
			① <(주)오키코리아>('http://www.okky.kr'이하 'OKKY')은(는) 다음의 개인정보 항목을 처리하고 있습니다.<br><br>
			
			1<홈페이지 회원가입 및 관리><br>
			
			필수항목 : 비밀번호, 로그인ID, 이메일, 접속 IP 정보, 쿠키, 서비스 이용 기록, 접속 로그<br>
			<h3>8. 개인정보의 파기</h3>
			<(주)오키코리아>('OKKY')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.<br><br>
			...
			<(주)오키코리아>('OKKY')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.<br>
		...
		<div id="btnDiv"><input type="button" id="closeBtn" name="closeBtn" value="닫기"></div>
		<br><br>
	</div>
	<script>
		window.resizeTo(600, 740);
