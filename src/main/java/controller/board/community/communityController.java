...
public class communityController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String pagingArea = BbsPage.pagingArea(total_page, page_no, page_block_start, page_block_end, "community.do?");
//		System.out.println("paging : " + pagingArea);
		...
		request.getRequestDispatcher("/board/community/community.jsp").forward(request,  response);
	}
